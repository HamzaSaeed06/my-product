...
import { admissionInquiriesRouter } from "./modules/admission-inquiries/routes.js";
...
import { staffAttendanceRouter } from "./modules/staff-attendance/routes.js";
...
import { classDiaryRouter } from "./modules/class-diary/routes.js";
...
import { terminologyRouter } from "./modules/terminology/routes.js";
import { featureConfigRouter } from "./modules/feature-config/routes.js";
...
export function createApp(): Express {
  ...
  app.use("/api/v1/feature-config", featureConfigRouter);
  ...
  app.use("/api/v1/admission-inquiries", admissionInquiriesRouter);
  ...
  app.use("/api/v1/class-diary", classDiaryRouter);
