...
export const ALL_PERMISSIONS = [
  ...
  "promotion.create",
  "promotion.approve",
  // Fee Categories have no separate permission namespace in the real
  // backend — create/edit/archive on categories is gated by these same
  // fee_structure.* strings, confirmed from routes.ts.
  "fee_structure.view",
