...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-1 overflow-y-auto py-2 group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  const stateProps = { "data-slot": "sidebar-group-label", "data-sidebar": "group-label" }
  if (render) {
    return cloneRender(render, classes, children, { ...stateProps, ...props })
  }
  return (
    <div className={classes} {...stateProps} {...props}>
      {children}
    </div>
  )
}
...
function SidebarGroupAction({
  ...
  const stateProps = { "data-slot": "sidebar-group-action", "data-sidebar": "group-action" }
  if (render) {
    return cloneRender(render, classes, children, { ...stateProps, ...props })
  }
  return (
...
function SidebarMenuAction({
  ...
  const stateProps = { "data-slot": "sidebar-menu-action", "data-sidebar": "menu-action" }
  if (render) {
    return cloneRender(render, classes, children, { ...stateProps, ...props })
  }
  return (
...
function SidebarMenuSubButton({
  ...
  return (
    <a className={classes} {...stateProps} {...props}>
      {children}
    </a>
  )
}
