...
// Ported from the sibling product/web app's data-table.tsx (same component,
// same API) — this app previously had no equivalent, so every list page
// (Customers, Licenses, Deployments, Support) was a bare unsorted,
// unsearchable, unpaginated <Table>, flagged in the UI/UX audit as
// undercutting the "triage many customers/tickets fast" job this tool
// exists for. Client-side sort/filter/paginate on an already-fetched array
// — correct for this app's dataset sizes.
